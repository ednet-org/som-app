...
class ProvidersApi {
  ...
  Future<Response<void>> providersCompanyIdApprovePost({ 
    ...
    try {
      const _type = FullType(ProvidersCompanyIdApprovePostRequest);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProviderProfile>> providersCompanyIdGet({ 
    required String companyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/providers/{companyId}'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ProvidersCompanyIdPaymentDetailsPut200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ProvidersCompanyIdPaymentDetailsPut200Response>> providersCompanyIdPaymentDetailsPut({ 
    required String companyId,
    ...
    final _path = r'/providers/{companyId}/paymentDetails'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BankDetails);
      _bodyData = _serializers.serialize(bankDetails, specifiedType: _type);
    ...
    ProvidersCompanyIdPaymentDetailsPut200Response? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ProvidersCompanyIdPaymentDetailsPut200Response),
      ) as ProvidersCompanyIdPaymentDetailsPut200Response;
    ...
    return Response<ProvidersCompanyIdPaymentDetailsPut200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Product>>> providersCompanyIdProductsGet({ 
    required String companyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/providers/{companyId}/products'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> providersCompanyIdProductsPost({ 
    required String companyId,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> providersCompanyIdProductsProductIdDelete({ 
    required String companyId,
    ...
    final _path = r'/providers/{companyId}/products/{productId}'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'productId' '}', encodeQueryParameter(_serializers, productId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Product] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Product>> providersCompanyIdProductsProductIdPut({ 
    required String companyId,
    required String productId,
    required ProductInput productInput,
    CancelToken? cancelToken,
