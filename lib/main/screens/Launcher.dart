                                  ...
                                  child: Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      category(appCat1, app_ic_phone, appLblFullApps, isNew: true, type: snapshot.data!.fullApp!.type, onTap: () {
                                        ScreenListing(snapshot.data!.fullApp).launch(context);
                                      }),
                                      category(appCat2, app_dashboard, appLblDashboard, type: snapshot.data!.dashboard!.type, onTap: () {
                                        ScreenListing(snapshot.data!.dashboard).launch(context);
                                      }),
                                      category(appCat3, app_ic_phone, appLblIntegrations, onTap: () {
                                        ScreenListing(snapshot.data!.integrations).launch(context);
                                      }, isNew: true),
                                    ],
                                  ),
                                ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 6),
              Text("Would like to made your day to day life easier and save some time for thins which matter? Start now with Smart offer management", style: secondaryTextStyle(size: 16), textAlign: TextAlign.center),
              SizedBox(height: 24),
              ElevatedButton(
