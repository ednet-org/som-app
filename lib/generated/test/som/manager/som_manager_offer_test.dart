  ...
  group("Testing Som.Manager.Offer", () {
    ...
    test("Select offers by attribute", () {
      ...
      selectedOffers.forEach(
          (se) => expect(se.description, equals(randomOffer.description)));
    ...
    test("Copy offers", () {
      ...
      copiedOffers
          .forEach((e) => expect(e, equals(offers.singleWhereOid(e.oid))));
      copiedOffers
          .forEach((e) => expect(e, isNot(same(offers.singleWhereId(e.id!)))));
    ...
    test("Copy Equality", () {
      ...
      expect(
          randomOffer.expirationDate, equals(randomOfferCopy.expirationDate));
    ...
    test("offer action undo and redo", () {
      ...
      offer.status = 'judge';
      offer.expirationDate = new DateTime.now();
      offer.price = 65.27238102877614;
      var offerProvider = providers.random();
    ...
    test("Offer update undo and redo", () {
      ...
      var action = SetAttributeCommand(session, offer, "description", 'school');
      action.doIt();
    ...
    test("Reactions to offer actions", () {
      ...
      var setAttributeCommand =
          SetAttributeCommand(session, offer, "description", 'money');
...
void main() {
  ...
  testSomManagerOffers(somDomain, managerModel, offers, providers, inquiries);
}
