...
final Logger _channelAdapterLogger = Logger(
  'ednet_core.patterns.channel_adapter',
);
...
class HttpChannelAdapter implements ChannelAdapter {
  ...
  Future<void> handleRequest(HttpRequest request) async {
    try {
      ...
      // Log exception
      _channelAdapterLogger.warning('Error handling HTTP request: $e');
      rethrow;
    }
  }
  ...
  void _handleChannelMessage(Message message) {
    ...
    _channelAdapterLogger.fine('Received message from channel: ${message.id}');
  }
...
class WebSocketChannelAdapter implements ChannelAdapter {
  ...
  void _handleChannelMessage(Message message) {
    ...
    _channelAdapterLogger.fine('Would send to WebSocket clients: $data');
  }
