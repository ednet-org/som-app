...
class OffersApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InquiriesInquiryIdPdfGeneratePost200Response>> offersOfferIdPdfGeneratePost({ 
    required String offerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/offers/{offerId}/pdf/generate'.replaceAll('{' r'offerId' '}', encodeQueryParameter(_serializers, offerId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InquiriesInquiryIdPdfGet200Response>> offersOfferIdPdfGet({ 
    required String offerId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/offers/{offerId}/pdf'.replaceAll('{' r'offerId' '}', encodeQueryParameter(_serializers, offerId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
