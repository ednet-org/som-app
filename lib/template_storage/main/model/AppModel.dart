...
class AppTheme {
  ...
  ThemeConfiguration? template_storage;
  ThemeConfiguration? integrations;
  ThemeConfiguration? webApps;

  AppTheme({this.themes, this.screenList, this.dashboard, this.fullApp, this.widgets, this.template_storage, this.integrations, this.webApps});
  ...
  factory AppTheme.fromJson(Map<String, dynamic> json) {
    return AppTheme(
      ...
      template_storage: json['template_storage'] != null ? ThemeConfiguration.fromJson(json['template_storage']) : null,
