...
void main() {
  group('Entities Filtering and Sorting Tests using EDNetOne Democracy Domain', () {
    ...
    setUp(() {
      ...
      // alice is automatically added by createCitizen
      ...
      // bob is automatically added by createCitizen
      ...
      // charlie is automatically added by createCitizen
      ...
      // dave is automatically added by createCitizen
      ...
      // eve is automatically added by createCitizen
    });
    ...
    test('Entities chaining filtering and sorting operations', () {
      ...
      final names = recentVerifiedNames
          .map((citizen) => citizen.getAttribute('name') as String)
          .toList();
