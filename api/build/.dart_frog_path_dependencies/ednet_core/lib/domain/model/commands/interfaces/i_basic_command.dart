...
final Logger _basicCommandLogger = Logger('ednet_core.commands.basic');
...
abstract class IBasicCommand implements ICommand {
  ...
  void display({String title = 'BasicCommand', StringSink? out}) {
    ...
    if (out == null) {
      _basicCommandLogger.fine(sink.toString());
    }
  }
}
