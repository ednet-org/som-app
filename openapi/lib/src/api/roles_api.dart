...
class RolesApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [BuiltList<Role>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<Role>>> rolesGet({ 
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Role>> rolesPost({ 
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> rolesRoleIdDelete({ 
    ...
    final _path = r'/roles/{roleId}'.replaceAll('{' r'roleId' '}', encodeQueryParameter(_serializers, roleId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [Role] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Role>> rolesRoleIdPut({ 
    required String roleId,
    required RoleInput roleInput,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
