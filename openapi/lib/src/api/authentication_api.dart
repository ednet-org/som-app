...
class AuthenticationApi {
  ...
  Future<Response<String>> authForgotPasswordPost({ 
    ...
    try {
      ...
      _bodyData = forgotPasswordDto == null ? null : _serializers.serialize(forgotPasswordDto, specifiedType: _type);
  ...
  Future<Response<AuthenticateResultDto>> authLoginPost({ 
    ...
    try {
      const _type = FullType(AuthenticateDto);
      _bodyData = authenticateDto == null ? null : _serializers.serialize(authenticateDto, specifiedType: _type);
