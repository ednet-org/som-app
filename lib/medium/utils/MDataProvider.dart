...
List<MListModel> getSavingPostList() {
  List<MListModel> list = List<MListModel>();
...
List<MTopicModel> getTopicList() {
  List<MTopicModel> list = List<MTopicModel>();
...
List<MPeopleModel> getPeopleFlutterList() {
  List<MPeopleModel> list = List<MPeopleModel>();
...
List<MPeopleModel> getPublicationList() {
  ...
  list.add(MPeopleModel(img: mCatDesign, title: 'Dr.Smith', subTitle: 'Google Developers Expert @Flutter,Mobile Developers, Public Speaker, Technical Blogger.'));
  return list;
}
...
List<MStoriesModel> getStoriesList() {
  List<MStoriesModel> list = List<MStoriesModel>();
...
List<MSelectTopicModel> getSelectTopicList() {
  List<MSelectTopicModel> list = List<MSelectTopicModel>();
