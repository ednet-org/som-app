...
void testSomManagerCompanies( 
  ...
  group("Testing Som.Manager.Company", () { 
    ...
    test("Select companies by attribute, then add", () { 
      ...
      company.uidNumber = 'present'; 
      company.registrationNumber = 'electronic'; 
      company.numberOfEmployees = 'sailing'; 
    ...
    test("Random company", () { 
      var company1 = companies.random(); 
      expect(company1, isNotNull); 
      var company2 = companies.random(); 
    ...
    test("Update company non id attribute with failure", () { 
      ...
      afterUpdateEntity.name = 'sun'; 
      expect(afterUpdateEntity.name, equals('sun')); 
      // companies.update can only be used if oid, code or id is set. 
      expect(() => companies.update(randomCompany, afterUpdateEntity), throws); 
    }); 
    ...
    test("company action undo and redo", () { 
      ...
      var company = Company(companies.concept); 
        company.name = 'milk'; 
      company.role = 'candy'; 
      company.address = 'message'; 
      company.uidNumber = 'cash'; 
      company.registrationNumber = 'cream'; 
      company.numberOfEmployees = 'present'; 
      company.websiteUrl = 'question'; 
    var companyCategories = categories.random(); 
    company.categories = companyCategories; 
      companies.add(company); 
    companyCategories.companies.add(company); 
    ...
    test("company session undo and redo", () { 
      var companyCount = companies.length; 
      var company = Company(companies.concept); 
        company.name = 'fascination'; 
      company.role = 'consciousness'; 
      company.address = 'park'; 
      company.uidNumber = 'right'; 
      company.registrationNumber = 'selfdo'; 
      company.numberOfEmployees = 'body'; 
      company.websiteUrl = 'service'; 
    var companyCategories = categories.random(); 
    company.categories = companyCategories; 
      companies.add(company); 
    companyCategories.companies.add(company); 
    ...
    test("Company update undo and redo", () { 
      ...
      var action = SetAttributeCommand(session, company, "name", 'grading'); 
      action.doIt(); 
    ...
    test("Reactions to company actions", () { 
      ...
      company.uidNumber = 'selfie'; 
      company.registrationNumber = 'answer'; 
      company.numberOfEmployees = 'teacher'; 
      company.websiteUrl = 'beer'; 
    var companyCategories = categories.random(); 
    company.categories = companyCategories; 
      companies.add(company); 
    companyCategories.companies.add(company); 
      ...
      var setAttributeCommand = SetAttributeCommand( 
        session, company, "name", 'explanation'); 
