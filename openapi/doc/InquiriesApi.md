...
# **inquiriesInquiryIdPdfGet**
> InquiriesInquiryIdPdfGet200Response inquiriesInquiryIdPdfGet(inquiryId)
...
try {
    final response = api.inquiriesInquiryIdPdfGet(inquiryId);
    print(response);
} catch on DioException (e) {
    print('Exception when calling InquiriesApi->inquiriesInquiryIdPdfGet: $e\n');
}
```
