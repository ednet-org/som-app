...
import 'package:som/defaultTheme/screen/MessageScreen.dart';
...
class ChatScreenState extends State<ChatScreen> {
  ...
  List<ChatModel> chats = getChatData();
  var personName = '';
  ...
  sendClick() async {
    ...
    if (msgController.text.trim().isNotEmpty) {
      ...
      var msgModel1 = ChatMessageModel();
              ...
              children: [
                Container(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (_, index) {
                      ChatMessageModel data = msgListing[index];
