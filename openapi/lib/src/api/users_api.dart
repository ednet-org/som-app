...
class UsersApi {
  ...
  Future<Response<void>> companiesCompanyIdRegisterUserPost({ 
    ...
    try {
      const _type = FullType(UserRegistration);
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> companiesCompanyIdUsersUserIdRemovePost({ 
    required String companyId,
    required String userId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/Companies/{companyId}/users/{userId}/remove'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString()).replaceAll('{' r'userId' '}', encodeQueryParameter(_serializers, userId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UsersLoadUserWithCompanyGet200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersLoadUserWithCompanyGet200Response>> usersLoadUserWithCompanyGet({ 
    required String userId,
    String? companyId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/Users/loadUserWithCompany';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
