...
- **Technical Details**: `.cursor/technical.learned.knowledge/packages/configuration.package.md`
- **TDD Memory**: `.cursor/project.memory/tdd/packages/configuration.tdd.md`
