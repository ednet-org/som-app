...
final Logger _timeBasedPolicyLogger = Logger('ednet_core.policy.time_based');
...
class TimeBasedPolicy implements IPolicy {
  ...
  bool _evaluateTime(Entity entity) {
    ...
    if (timeAttribute == null || timeAttribute is! DateTime) {
      _timeBasedPolicyLogger.warning(
  ...
  void log(
    ...
    _timeBasedPolicyLogger.info(
      'Time-based policy violation: $description. '
...
/// Returns true if the time condition is satisfied, false otherwise.
typedef TimeValidator =
    bool Function(DateTime attributeTime, DateTime currentTime);
