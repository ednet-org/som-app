...
final Logger _attributePolicyLogger = Logger('ednet_core.policy.attribute');
...
class AttributePolicy extends Policy {
  ...
  AttributePolicy({
    ...
    PolicyScope? scope,
         ...
         if (!isValid) {
           _attributePolicyLogger.fine(
             'Policy "$name" failed for value: $value',
           );
         }
         return isValid;
       }, scope: scope);
  ...
  bool evaluate(Entity entity) {
    ...
    if (value == null) {
      _attributePolicyLogger.fine(
        'Policy "$name" failed: attribute "$attributeName" is null.',
      );
      return false;
    }
    ...
    if (!isValid) {
      _attributePolicyLogger.fine(
        'Policy "$name: $description" failed for value: $value',
      );
    }
    return isValid;
  }
...
class AttributeValidators {
  ...
  static bool Function(dynamic) isEmail = withDebug(
    (value) =>
        value is String &&
  ...
  static bool Function(dynamic) isUrl = withDebug(
    (value) => value is String && Uri.tryParse(value) != null,
  );

  /// Validates that a value is a valid phone number.
  static bool Function(dynamic) isPhoneNumber = withDebug(
    (value) =>
        value is String &&
  ...
  static bool Function(dynamic) isDate = withDebug(
  ...
  static bool Function(dynamic) isPositive = withDebug(
    (value) => value is num && value > 0,
  );

  /// Validates that a value is negative (< 0).
  static bool Function(dynamic) isNegative = withDebug(
    (value) => value is num && value < 0,
  );

  /// Validates that a value is non-negative (>= 0).
  static bool Function(dynamic) isNonNegative = withDebug(
    (value) => value is num && value >= 0,
  );

  /// Validates that a value is non-positive (<= 0).
  static bool Function(dynamic) isNonPositive = withDebug(
    (value) => value is num && value <= 0,
  );
  ...
  static bool Function(Entity) hasParentType(String parentType) => withDebug(
    (e) => e.concept.parents.any((parent) => parent.runtimeType == parentType),
  );
  ...
  static bool Function(Entity) hasParentWithAttribute(String attributeName) =>
      withDebug(
        (e) => e.concept.parents.any(
          (parent) => parent.getAttribute(attributeName) != null,
        ),
      );
  ...
  static bool Function(Entity) hasChildWithAttribute(String attributeName) =>
      withDebug(
        (e) => e.concept.children.any(
          (child) => child.getAttribute(attributeName) != null,
        ),
      );
  ...
  static bool Function(Entity) isNeighborOf(Entity neighbor) => withDebug(
    (e) =>
  ...
  static bool Function(Entity) isTypeWithNeighbor(Entity neighbor) => withDebug(
    (e) =>
  ...
  static bool Function(Entity) isTypeWithParent(Entity parent) => withDebug(
    (e) =>
  ...
  static bool Function(Entity) isTypeWithChild(Entity child) => withDebug(
    (e) =>
  ...
  static bool Function(Entity) isTypeWithNeighborType(
    Type neighborType,
  ) => withDebug(
    (e) =>
        e.runtimeType == neighborType ||
        e.concept.children.any((child) => child.runtimeType == neighborType) ||
