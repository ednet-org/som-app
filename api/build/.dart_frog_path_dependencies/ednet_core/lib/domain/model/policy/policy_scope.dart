...
class PolicyScope {
  ...
  /// Factory method for entity-level scope (commonly used in tests)
  static PolicyScope get entity => PolicyScope({'Entity'});

  /// Factory method for global scope (commonly used in tests)
  static PolicyScope get global => PolicyScope({});
  ...
  PolicyScope merge(PolicyScope? other) {
    ...
    return PolicyScope(applicableConcepts.union(other.applicableConcepts), {
      ...conditions,
      ...other.conditions,
    });
  }
