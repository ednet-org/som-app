...
class Permission {
  ...
  bool implies(Permission other) {
    ...
    if (resource.endsWith('.*') &&
        other.resource.startsWith(resource.substring(0, resource.length - 2))) {
...
abstract class SecuritySubject {
  ...
  /// Gets the display name for this subject.
...
class SecurityException implements Exception {
  ...
  /// The permission that was required but not found.
  ...
  /// - [subject]: The subject that attempted the operation
  SecurityException(this.message, {this.requiredPermission, this.subject});
