...
String genEDNetWeb(Model model) {
  ...
  var sc = ' \n';
  sc =
      '${sc}// web/${domain.codeLowerUnderscore}/${model.codeLowerUnderscore}/'
  ...
  sc =
      '${sc}import "package:${domain.codeLowerUnderscore}_'
  ...
  sc =
      '${sc}   ${model.code}Model? ${model.codeFirstLetterLower}Model = '
  ...
  sc = '${sc}   // TODO: Implement showData UI. \n';
  sc = '${sc}} \n';
  sc = '${sc} \n';
