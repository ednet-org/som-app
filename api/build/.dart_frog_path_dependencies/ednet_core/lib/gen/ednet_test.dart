...
String genEDNetGen(Model model) {
  ...
  final buffer = StringBuffer()
    ..writeln()
    ..writeln(
      '// test/${domain.codeLowerUnderscore}/${model.codeLowerUnderscore}/${domain.codeLowerUnderscore}_${model.codeLowerUnderscore}_gen.dart',
    )
    ..writeln()
    ...
    ..writeln(
      '  repository.gen(\'${domain.codeLowerUnderscore}_${model.codeLowerUnderscore}\');',
    )
    ..writeln('}')
    ..writeln()
...
String genEDNetTest(CoreRepository repo, Model model, Concept entryConcept) {
  ...
  final repoName =
      '${domain.codeFirstLetterUpper}${model.codeFirstLetterUpper}Repo';
  var sc = ' \n';
  sc =
      '$sc// test/${domain.codeLowerUnderscore}/'
  ...
  sc =
      '${sc}import \'../../../lib/${domain.codeLowerUnderscore}_'
  ...
  sc =
      '${sc}void test${domain.code}${model.code}'
      '${entryConcept.codePluralFirstLetterUpper}( \n';
  sc =
      '$sc    ${domain.code}Domain ${domain.codeFirstLetterLower}Domain, '
  ...
  sc =
      '$sc      expect(${model.codeFirstLetterLower}Model.isEmpty, '
      'isFalse); \n';
  ...
  sc =
      '$sc      final json = ${model.codeFirstLetterLower}Model.'
      'fromEntryToJson(\'$entity2\'); \n';
  sc = '$sc      expect(json, isNotNull); \n';
  sc = '$sc \n';
  sc =
      '$sc      //${model.codeFirstLetterLower}Model.'
  ...
  if (requiredNonIdAttribute != null) {
    ...
    sc =
        '$sc      expect($entities.exceptions.toList()[0].category, '
        'equals(\'required\')); \n';
    sc = '$sc \n';
    sc =
        '$sc      $entities.exceptions.display(title: \'Add $entity required '
        'error\'); \n';
  } else {
  ...
  if (idAttribute != null) {
    if (idAttribute.increment == null) {
      ...
      sc = '$sc      final $entity = $entity2(${entity}Concept); \n';
      sc =
          '$sc      final random$entity2 = ${model.codeFirstLetterLower}Model.$entities.random(); \n';
      sc =
          '$sc      $entity.${idAttribute.code} = '
      ...
      sc = '$sc \n';
      sc =
          '$sc      $entities.exceptions.display(title: \'Add $entity unique '
          'error\'); \n';
    } else {
  ...
  if (idAttribute != null) {
    ...
    sc = '$sc      final $entity = \n';
    sc =
        '$sc          $entities.singleWhereAttributeId('
        '\'${idAttribute.code}\', random$entity2.${idAttribute.code}); \n';
    sc = '$sc      expect($entity, isNotNull); \n';
    sc =
        '$sc      expect($entity!.${idAttribute.code}, '
  ...
  if (requiredNonIdAttribute != null) {
    ...
    sc = '$sc      final $entity = \n';
    sc =
        '$sc          $entities.firstWhereAttribute('
        '\'${requiredNonIdAttribute.code}\', '
        'random$entity2.${requiredNonIdAttribute.code}); \n';
    sc = '$sc      expect($entity, isNotNull); \n';
    sc =
        '$sc      expect($entity.${requiredNonIdAttribute.code}, '
  ...
  if (nonRequiredAttribute != null) {
    ...
    sc = '$sc      expect($entity, isNotNull); \n';
    sc =
        '$sc      expect($entity.${nonRequiredAttribute.code}, '
  ...
  if (nonRequiredAttribute != null) {
    ...
    sc =
        '$sc          $entities.selectWhereAttribute('
        '\'${nonRequiredAttribute.code}\', random$entity2.'
        '${nonRequiredAttribute.code}); \n';
    sc = '$sc      expect(selected$entities2.isEmpty, isFalse); \n';
    sc = '$sc      for (final se in selected$entities2) {';
    sc =
        '$sc        expect(se.${nonRequiredAttribute.code}, equals(random$entity2.${nonRequiredAttribute.code}));';
    sc = '$sc      }';
    sc = '$sc \n';
    sc =
        '$sc      //selected$entities2.display(title: \'Select $entities by '
        '${nonRequiredAttribute.code}\'); \n';
  } else {
    sc = '$sc      // no attribute that is not required \n';
  }
  ...
  if (requiredNonIdAttribute != null) {
    ...
    sc =
        '$sc          expect(se.${requiredNonIdAttribute.code}, '
        'equals(random$entity2.${requiredNonIdAttribute.code}))); \n';
    sc = '$sc \n';
    sc =
        '$sc      //selected$entities2.display(title: \'Select $entities by '
  ...
  if (nonIdAttribute != null) {
    ...
    sc = '$sc \n';
    sc =
        '$sc      final removed = selected$entities2.remove(random$entity2); \n';
  ...
  if (idAttribute != null) {
    ...
    sc =
        '$sc      expect(ordered$entities2.length, '
        'equals($entities.length)); \n';
    sc = '$sc      expect(ordered$entities2.source?.isEmpty, isFalse); \n';
    sc =
        '$sc      expect(ordered$entities2.source?.length, '
        'equals($entities.length)); \n';
  ...
  sc =
      '$sc      expect(copied$entities2.length, '
      'equals($entities.length)); \n';
  ...
  sc =
      '$sc      final ${entity}1 = ${model.codeFirstLetterLower}Model.$entities.random(); \n';
  sc = '$sc      expect(${entity}1, isNotNull); \n';
  sc =
      '$sc      final ${entity}2 = ${model.codeFirstLetterLower}Model.$entities.random(); \n';
  ...
  if (idAttribute != null) {
    if (idAttribute.increment == null) {
      sc =
          '$sc      final random$entity2 = ${model.codeFirstLetterLower}Model.$entities.random(); \n';
      sc =
          '$sc      final beforeUpdate = random$entity2.${idAttribute.code}; \n';
      sc = '$sc      try { \n';
      var attributeSet = setTestAttributeRandomly(
        idAttribute,
        'random$entity2',
      );
      ...
      sc =
          '$sc        expect(random$entity2.${idAttribute.code}, '
          'equals(beforeUpdate)); \n';
      sc = '$sc      } \n';
    } else {
      sc = '$sc      // id attribute defined as increment, cannot update it \n';
  ...
  if (idAttribute != null) {
    if (idAttribute.increment == null) {
      ...
      sc =
          '$sc      final attribute = random$entity2.concept.attributes.'
      ...
      sc =
          '$sc      expect(afterUpdateEntity.${idAttribute.code}, '
          'equals($value)); \n';
      sc = '$sc      attribute?.update = false; \n';
      sc =
          '$sc      final updated = $entities.update(random$entity2, '
          'afterUpdateEntity); \n';
      sc = '$sc      expect(updated, isTrue); \n';
      sc = '$sc \n';
      sc =
          '$sc      final entity = $entities.singleWhereAttributeId('
  ...
  if (nonIdAttribute != null) {
    ...
    sc =
        '$sc      final afterUpdateEntity = random$entity2.copy()..${nonIdAttribute.code} = $value; \n';
    sc =
        '$sc      expect(afterUpdateEntity.${nonIdAttribute.code}, '
        'equals($value)); \n';
    sc =
        '$sc      // $entities.update can only be used if oid, code or '
        'id is set. \n';
    sc =
        '$sc      expect(() => $entities.update(random$entity2, '
  ...
  sc =
      '$sc      final random$entity2 = ${model.codeFirstLetterLower}Model.$entities.random()..display(prefix:\'before copy: \'); \n';
  sc =
      '$sc      final random${entity2}Copy = random$entity2.copy()..display(prefix:\'after copy: \'); \n';
  sc = '$sc      expect(random$entity2, equals(random${entity2}Copy)); \n';
  sc =
      '$sc      expect(random$entity2.oid, equals(random${entity2}Copy.oid)); \n';
  sc =
      '$sc      expect(random$entity2.code, '
      'equals(random${entity2}Copy.code)); \n';
  for (Attribute attribute in entryConcept.attributes.whereType<Attribute>()) {
    sc =
        '$sc      expect(random$entity2.${attribute.code}, '
  ...
  sc = '$sc \n';
  sc =
      '$sc      final action = AddCommand(session, $entities, $entity)..doIt(); \n';
  sc = '$sc      expect($entities.length, equals(++${entity}Count)); \n';
  sc = '$sc \n';
  sc = '$sc      action.undo(); \n';
  sc = '$sc      expect($entities.length, equals(--${entity}Count)); \n';
  ...
  if (nonIdAttribute != null) {
    sc =
        '$sc      final $entity = ${model.codeFirstLetterLower}Model.$entities.random(); \n';
    var value = genAttributeTextRandomly(nonIdAttribute);
    sc =
        '$sc      final action = SetAttributeCommand(session, '
        '$entity, \'${nonIdAttribute.code}\', $value)..doIt(); \n';
    sc = '$sc \n';
    sc = '$sc      session.past.undo(); \n';
    sc =
        '$sc      expect($entity.${nonIdAttribute.code}, '
  ...
  sc = '$sc \n';
  sc =
      '$sc      RemoveCommand(session, $entities, '
      '${entity}1).doIt(); \n';
  sc = '$sc      expect($entities.length, equals(--${entity}Count)); \n';
  sc = '$sc \n';
  sc =
  ...
  sc = '$sc      } \n';
  sc =
      '$sc      final action1 = RemoveCommand(session, $entities, '
      '${entity}1); \n';
  sc =
      '$sc      final action2 = RemoveCommand(session, $entities, '
      '${entity}2); \n';
  sc = '$sc \n';
  ...
  sc =
      '$sc        \'two removes on $entities, with an error on the second\',\n';
  sc = '$sc        session, \n';
  sc = '$sc        )\n';
  sc = '$sc        ..add(action1) \n';
  sc = '$sc        ..add(action2); \n';
  ...
  sc = '$sc \n';
  sc =
      '$sc      final session = ${domain.codeFirstLetterLower}Domain.newSession(); \n';
  sc =
      '$sc      AddCommand(session, $entities, '
      '$entity).doIt(); \n';
  sc = '$sc      expect($entities.length, equals(++${entity}Count)); \n';
  ...
  sc =
      '$sc  final ${domain.codeFirstLetterLower}Domain = '
      'repository.getDomainModels(\'${domain.code}\') as ${domain.code}Domain?;\n';
  sc =
      '$sc  assert(${domain.codeFirstLetterLower}Domain != null, \'${domain.code}Domain is not defined\'); \n';
  sc =
      '$sc  final ${model.codeFirstLetterLower}Model = '
      '${domain.codeFirstLetterLower}Domain!.getModelEntries(\'${model.code}\') as ${model.code}Model?;\n';
  sc =
      '$sc  assert(${model.codeFirstLetterLower}Model != null, \'${model.code}Model is not defined\'); \n';
  sc =
      '$sc  final $entities = '
      '${model.codeFirstLetterLower}Model!.$entities; \n';
  sc =
      '$sc  test${domain.code}${model.code}'
      '${entryConcept.codePluralFirstLetterUpper}('
