...
final Logger _messageFilterLogger = Logger(
  'ednet_core.patterns.message_filter',
);
...
class SelectorMessageFilter<T> implements MessageFilter {
  ...
  Future<void> _processMessage(Message message) async {
    ...
    try {
      ...
      _messagesFiltered++;
      _messageFilterLogger.warning('Error filtering message: $e');
    }
  }
}
