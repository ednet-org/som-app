...
abstract class IEventTriggeredPolicy {
  /// The name of this policy for identification and logging
  String get name;

  /// Evaluates whether this policy applies to the given entity
  ///
  /// Parameters:
  /// - [entity]: The entity to evaluate
  ///
  /// Returns:
  /// True if this policy applies to the entity, false otherwise
