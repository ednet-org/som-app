...
- **Technical Details**: `.cursor/technical.learned.knowledge/packages/aggregate_root.package.md`
- **TDD Memory**: `.cursor/project.memory/tdd/packages/aggregate_root.tdd.md`
