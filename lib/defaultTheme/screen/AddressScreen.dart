...
class AddressScreen extends StatefulWidget {
  static String tag = 'AddressScreen';
...
class AddressScreenState extends State<AddressScreen> {
  List<AddressListModel> list = getAddressList();
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              AddressListModel model = await showInDialog(context, child: AddAddressDialog(), backgroundColor: Colors.transparent, contentPadding: EdgeInsets.all(0));
            ...
            ListView.builder(
              ...
              itemBuilder: (_, index) {
                AddressListModel data = list[index];
