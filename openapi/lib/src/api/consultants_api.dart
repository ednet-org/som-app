...
class ConsultantsApi {
  ...
  const ConsultantsApi(this._dio, this._serializers);
  ...
  Future<Response<void>> consultantsRegisterCompanyPost({ 
    ...
    final _path = r'/consultants/registerCompany';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ConsultantsRegisterCompanyPostRequest);
