...
class AvailableForHireWidgetState extends State<AvailableForHireWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Image.network(p1HireImg, height: context.height(), width: context.width(), fit: BoxFit.cover),
          /*Container(
            height: context.height(),
            width: context.width(),
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      children: [
                        24.height,
                        Image.network(p1DesignIcon, height: 50, width: 50, color: Colors.green),
                        24.height,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        24.height,
                        Image.network(p1MarketingIcon, height: 50, width: 50, color: Colors.green),
                        24.height,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        24.height,
                        Image.network(p1PhotographyIcon, height: 50, width: 50, color: Colors.green),
                        24.height,
