...
class SomLocalizations {
  ...
  static const LocalizationsDelegate<SomLocalizations> delegate = _SomLocalizationsDelegate();
...
class _SomLocalizationsDelegate extends LocalizationsDelegate<SomLocalizations> {
