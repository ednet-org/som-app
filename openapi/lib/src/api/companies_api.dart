...
class CompaniesApi {
  ...
  Future<Response<AuthChangePasswordPost200Response>> companiesCompanyIdActivatePost({ 
    ...
    final _path = r'/Companies/{companyId}/activate'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
  ...
  Future<Response<void>> companiesCompanyIdDelete({ 
    ...
    final _path = r'/Companies/{companyId}'.replaceAll('{' r'companyId' '}', encodeQueryParameter(_serializers, companyId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
