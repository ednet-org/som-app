...
class LauncherState extends State<Launcher>
    with TickerProviderStateMixin, AfterLayoutMixin<Launcher> {
  var selectedTab = 0;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              SizedBox(height: 6),
              Text(
                  "Would like to made your day to day life easier and save some time for thins which matter? Start now with Smart offer management",
