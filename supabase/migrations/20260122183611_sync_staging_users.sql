-- Migration: Sync staging auth users to som.users and som.user_company_roles
-- This ensures auth users have corresponding som.users and company role entries
...
SELECT
  au.id, '22222222-2222-2222-2222-222222222222', au.email,
...
SELECT au.id, '22222222-2222-2222-2222-222222222222', '["provider", "admin"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'provider-admin@test.som-staging.at'
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '22222222-2222-2222-2222-222222222222', '["provider"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'provider-employee@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
...
SELECT
  au.id, '11111111-1111-1111-1111-111111111111', au.email,
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '11111111-1111-1111-1111-111111111111', '["buyer", "admin"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'buyer-admin@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '11111111-1111-1111-1111-111111111111', '["buyer"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'buyer-employee@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
...
SELECT
  au.id, '33333333-3333-3333-3333-333333333333', au.email,
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '33333333-3333-3333-3333-333333333333', '["buyer", "provider", "admin"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'hybrid-admin@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
...
SELECT
  au.id, '00000000-0000-0000-0000-000000000001', au.email,
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '00000000-0000-0000-0000-000000000001', '["consultant"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'consultant@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
...
INSERT INTO som.user_company_roles (user_id, company_id, roles_json, created_at, updated_at)
SELECT au.id, '00000000-0000-0000-0000-000000000001', '["consultant", "admin"]', NOW(), NOW()
FROM auth.users au
WHERE au.email = 'sysadmin@test.som-staging.at'
ON CONFLICT (user_id, company_id) DO NOTHING;
