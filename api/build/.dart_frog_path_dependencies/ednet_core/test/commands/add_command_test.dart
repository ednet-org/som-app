...
void main() {
  group('Add Command in Direct Democracy Domain', () {
    ...
    test('Add Command should add citizen to citizens', () {
      ...
      // Create citizen WITHOUT adding to collection (for testing AddCommand)
    ...
    test('Transaction can group multiple add commands', () {
      ...
      citizen1.setAttribute('name', 'Jane Citizen');
      citizen1.setAttribute('email', 'jane@democracy.org');
