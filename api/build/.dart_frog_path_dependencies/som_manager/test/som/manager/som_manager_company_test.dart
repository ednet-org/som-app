...
void testSomManagerCompanies(
  ...
  group("Testing Som.Manager.Company", () {
    ...
    test("Find company by attribute", () {
      var randomCompany = managerModel.companies.random();
      var company = companies.firstWhereAttribute("name", randomCompany.name);
      expect(company, isNotNull);
    ...
    test("Select companies by attribute", () {
      ...
      selectedCompanies
          .forEach((se) => expect(se.name, equals(randomCompany.name)));
    ...
    test("Copy companies", () {
      ...
      copiedCompanies
          .forEach((e) => expect(e, equals(companies.singleWhereOid(e.oid))));
      copiedCompanies.forEach(
          (e) => expect(e, isNot(same(companies.singleWhereId(e.id!)))));
    ...
    test("Update company non id attribute with failure", () {
      ...
      expect(() => companies.update(randomCompany, afterUpdateEntity),
    ...
    test("Copy Equality", () {
      ...
      expect(randomCompany.registrationNumber,
          equals(randomCompanyCopy.registrationNumber));
      expect(randomCompany.numberOfEmployees,
          equals(randomCompanyCopy.numberOfEmployees));
    ...
    test("Reactions to company actions", () {
      ...
      var setAttributeCommand =
          SetAttributeCommand(session, company, "name", 'election');
