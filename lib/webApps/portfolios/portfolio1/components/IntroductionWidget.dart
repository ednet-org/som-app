...
class IntroductionWidgetState extends State<IntroductionWidget> {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(
        children: [
          Image.network(p1IntoImg, height: context.height(), width: context.width(), fit: BoxFit.cover),
          /*Container(
            height: context.height(),
            width: context.width(),
                ...
                child: Column(
                  ...
                  children: [
                    Container(
                      ...
                      color: white,
                      child: Image.network(p2User, height: 180, width: 180, fit: BoxFit.cover).cornerRadiusWithClipRRect(90),
