...
void main() {
  group('Message Filter Pattern', () {
    ...
    setUp(() {
      ...
      sourceChannel = InMemoryChannel(id: 'source_$uniqueId', broadcast: true);
      targetChannel = InMemoryChannel(id: 'target_$uniqueId', broadcast: true);
    });
    ...
    test(
      ...
      () async {
        ...
        await AsyncTestHelpers.waitForCondition(
          ...
          description: 'waiting for filtered message',
        );
